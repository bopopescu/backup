...
class Cluster(_messages.Message):
  ...
  Fields:
    ...
    enableKubernetesAlpha: Kubernetes alpha features are enabled on this
      ...
      may not be production ready in the kubernetes version of the main and
      nodes. The cluster has no SLA for uptime and main/node upgrades are
    ...
    mainIpv4CidrBlock: The IP prefix in CIDR notation to use for the hosted
      ...
      addresses to the main or set of mains, as well as the ILB VIP.
    ...
    privateCluster: If this is a private cluster setup. Private clusters are
      ...
      where nodes and the main communicate over private IP addresses.
  ...
  mainAuth = _messages.MessageField('MainAuth', 22)
  mainAuthorizedNetworks = _messages.MessageField('MainAuthorizedNetworks', 23)
  mainAuthorizedNetworksConfig = _messages.MessageField('MainAuthorizedNetworksConfig', 24)
  mainIpv4CidrBlock = _messages.StringField(25)
...
class ClusterUpdate(_messages.Message):
  ...
  desiredMainAuthorizedNetworks = _messages.MessageField('MainAuthorizedNetworks', 9)
  desiredMainAuthorizedNetworksConfig = _messages.MessageField('MainAuthorizedNetworksConfig', 10)
  desiredMainId = _messages.StringField(11)
  desiredMainMachineType = _messages.StringField(12)
