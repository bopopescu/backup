...
Modify basic_auth.csv and reset the K8S API server.
    ...
    SetMainAuth.method_config = lambda: base_api.ApiMethodInfo(
        flat_path=u'v1alpha1/projects/{projectsId}/locations/{locationsId}/clusters/{clustersId}:setMainAuth',
        http_method=u'POST',
        method_id=u'container.projects.locations.clusters.setMainAuth',
        ordered_params=[u'name'],
        path_params=[u'name'],
        query_params=[],
        relative_path=u'v1alpha1/{+name}:setMainAuth',
        request_field='<request>',
    ...
    UpdateMain.method_config = lambda: base_api.ApiMethodInfo(
        flat_path=u'v1alpha1/projects/{projectsId}/locations/{locationsId}/clusters/{clustersId}:updateMain',
        http_method=u'POST',
        method_id=u'container.projects.locations.clusters.updateMain',
        ordered_params=[u'name'],
        path_params=[u'name'],
        query_params=[],
        relative_path=u'v1alpha1/{+name}:updateMain',
        request_field='<request>',
  ...
  class ProjectsLocationsService(base_api.BaseApiService):
    ...
    def List(self, request, global_params=None):
      """List method for the projects_locations service.
...
`datahub.entries.getIamPolicy` on the specified resource.
...
Authorization requires the Google IAM permission
'datahub.entries.setIamPolicy' on the specified resource.
